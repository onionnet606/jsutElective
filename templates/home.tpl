					...
					<div class="layui-tab-item">
						...
						<div class="layui-inline">
							<div class="layui-input-inline" style="width: 120px;">
								<input type="text" id="sid" value="" placeholder="开始学号" autocomplete="off" class="layui-input">
							</div>
							<div class="layui-input-inline" style="width: 120px;">
								<input type="text" id="eid" value="" placeholder="结束学号" autocomplete="off" class="layui-input">
							</div>
						</div>
